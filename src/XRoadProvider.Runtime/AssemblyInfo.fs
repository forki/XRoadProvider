...
[<assembly: AssemblyTitleAttribute("XRoadProvider.Runtime")>]
...
[<assembly: AssemblyInformationalVersionAttribute("1.0.0-alpha011")>]
do ()

module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "XRoadProvider.Runtime"
    ...
    let [<Literal>] AssemblyInformationalVersion = "1.0.0-alpha011"
